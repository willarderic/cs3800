...
class RWmutex
{
  ...
  public:
    ...
    RWmutex& r_lock()
    {
      cout << "Locking read in r_lock()" << endl;
    ...
    RWmutex& w_lock()
    {
      cout << "Locking write lock in w_lock()" << endl;
    ...
    void r_unlock()
    {
      ...
      cout << "Unlocked read lock in r_unlock()" << endl;
    }
    ...
    void w_unlock()
    {
      ...
      read_cv.notify_all();
      write_cv.notify_all();
      cout << "Unlocked write lock in w_unlock()" << endl;
    }
};
